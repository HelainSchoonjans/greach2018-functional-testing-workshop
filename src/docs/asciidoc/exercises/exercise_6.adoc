...
- Replace all the references to /products by /secured/products in the urls.
- Run the test. They will fail, you try to access secured endpoints without providing a valid token.
